# regional-preferences Specification

## Purpose

Regional preferences (currency, language, number format) are loaded for the signed-in user, drive `MaterialApp` locale and shared monetary formatting, and propagate app-wide when preferences change.
