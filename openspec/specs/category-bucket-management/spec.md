# category-bucket-management Specification

## Purpose

Categories support the 50/30/20 budgeting model by storing a single bucket per category (`needs`, `wants`, or `savings_debt`) and exposing management from Settings.
