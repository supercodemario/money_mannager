# recurring-auto-push-sync Specification

## Purpose

Upload pending recurring templates, expenses, and occurrences automatically on mutation and during the automatic expense sync cycle, without remote pull, when the user is signed in and online.
