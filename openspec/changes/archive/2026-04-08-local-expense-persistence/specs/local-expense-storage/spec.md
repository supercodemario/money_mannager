...
- **THEN** the system SHALL persist a row with all required fields populated and timestamps set appropriately, including `created_by_user_id` matching the active local user
